...
async def start(client: Client, message: Message):
    await message.reply_video(
        video=f"https://telegra.ph/file/e4fe0e253cc818291afe8.jpg",
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            InlineKeyboardButton(
                text="☆ ʙʀᴀɴᴅᴇᴅ 💗 ", url=f"https://t.me/BongoBondhuSheikhMujiburRahman"
            ),
            InlineKeyboardButton(
                ...
                [
            InlineKeyboardButton(
                text="☆ ᴄʜᴀɴɴᴇʟ💗", url=f"http://t.me/Maesterouserbot"
            ),
                ],
                [
                    InlineKeyboardButton(
